...
public class CompletionTokenStreamTest extends BaseTokenStreamTestCase {
    ...
    public void testSuggestTokenFilter() throws Exception {
        ...
        assertTokenStreamContents(suggestTokenStream, new String[] {"mykeyword"}, null, null, new String[] {"Surface keyword|friggin payload|10"}, new int[] { 255 }, null, null);
    }
    ...
    public void testSuggestTokenFilterWithSynonym() throws Exception {
        ...
        assertTokenStreamContents(suggestTokenStream, new String[] {"mysynonym", "mykeyword"}, null, null, new String[] {"Surface keyword|friggin payload|10", "Surface keyword|friggin payload|10"}, new int[] { 254, 0 }, null, null);
    }
