...
import org.elasticsearch.search.suggest.completion.CompletionPostingsFormat.LookupFactory;
import org.elasticsearch.search.suggest.completion.CompletionPostingsFormat.SuggestLookupProvider;
...
public class AnalyzingSuggestLookupProvider extends SuggestLookupProvider {
    ...
    public AnalyzingSuggestLookupProvider(boolean preserveSep, boolean exactFirst, boolean preservePositionIncrements, boolean hasPayloads) {
        ...
        return new FieldsConsumer() {
            ...
            public TermsConsumer addField(final FieldInfo field) throws IOException {
                ...
                return new TermsConsumer() {
                    ...
                    final CompletionPostingsConsumer postingsConsumer = new CompletionPostingsConsumer(AnalyzingSuggestLookupProvider.this, builder);
    ...
    private static final class CompletionPostingsConsumer extends PostingsConsumer {
        ...
        private AnalyzingSuggestLookupProvider analyzingSuggestLookupProvider;
        private XAnalyzingSuggester.XBuilder builder;
        private int maxAnalyzedPathsForOneInput = 0;

        public CompletionPostingsConsumer(AnalyzingSuggestLookupProvider analyzingSuggestLookupProvider, XAnalyzingSuggester.XBuilder builder) {
        ...
        public void addPosition(int position, BytesRef payload, int startOffset, int endOffset) throws IOException {
             ...
             */
            maxAnalyzedPathsForOneInput = Math.max(maxAnalyzedPathsForOneInput, (256 - (position % 256) - 1));
        }
