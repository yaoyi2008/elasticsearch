...
import org.elasticsearch.search.suggest.completion.AnalyzingSuggestLookupProvider;
...
public class CompletionFieldMapper extends AbstractFieldMapper<String> {
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder<?, ?> parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            ...
            for (Map.Entry<String, Object> entry : node.entrySet()) {
                ...
                } else if (fieldName.equals("preserve_separators") || fieldName.equals("preserveSeparators")) {
                    builder.preserveSeparators(Boolean.parseBoolean(fieldNode.toString()));
                } else if (fieldName.equals("preserve_position_increments") || fieldName.equals("preservePositionIncrements")) {
    ...
    public CompletionFieldMapper(Names names, NamedAnalyzer indexAnalyzer, NamedAnalyzer searchAnalyzer, PostingsFormatProvider provider, SimilarityProvider similarity, boolean payloads,
        ...
        analyzingSuggestLookupProvider = new AnalyzingSuggestLookupProvider(preserveSeparators, false, preservePositionIncrements, payloads);
    ...
    public Field getCompletionField(String input, BytesRef payload) {
        return new SuggestField(name(), input, this.fieldType, payload, analyzingSuggestLookupProvider);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        return builder.startObject(name())
            ...
            .field("index_analyzer", indexAnalyzer.name())
            .field("search_analyzer", searchAnalyzer.name())
            .field("payloads", this.payloads)
            .field("preserve_separators", this.preserveSeparators)
            .field("preserve_position_increments", this.preservePositionIncrements)
        .endObject();
    }
